...
- SHA-256：`041cde3fde4ab81f515db0745b62c2cae3543bb68106abe9ad8aaca8fc97d2d9`
...
| 双字幕上下间隔 | `0` | `0` 到 `80` | 普通双字幕按照主、副字幕的实际 `Fontsize` 紧凑排列。此值只增加额外间隔，以 1080p 为基准；其他分辨率按视频高度同比例换算。 |
